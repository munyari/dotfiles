...
lua << END
  local package_path_str = "/Users/panashe/.cache/nvim/packer_hererocks/2.1.0-beta3/share/lua/5.1/?.lua;/Users/panashe/.cache/nvim/packer_hererocks/2.1.0-beta3/share/lua/5.1/?/init.lua;/Users/panashe/.cache/nvim/packer_hererocks/2.1.0-beta3/lib/luarocks/rocks-5.1/?.lua;/Users/panashe/.cache/nvim/packer_hererocks/2.1.0-beta3/lib/luarocks/rocks-5.1/?/init.lua"
  local install_cpath_pattern = "/Users/panashe/.cache/nvim/packer_hererocks/2.1.0-beta3/lib/lua/5.1/?.so"
...
local plugins = {
  ["deoplete.nvim"] = {
    ...
    only_sequence = false,
    only_setup = false,
    path = "/Users/panashe/.local/share/nvim/site/pack/packer/opt/deoplete.nvim"
  },
  ["packer.nvim"] = {
    loaded = false,
    only_sequence = false,
    only_setup = false,
    path = "/Users/panashe/.local/share/nvim/site/pack/packer/opt/packer.nvim"
  },
  tabular = {
    commands = { "Tabular" },
    loaded = false,
    only_sequence = false,
    only_setup = false,
    path = "/Users/panashe/.local/share/nvim/site/pack/packer/opt/tabular"
  },
  ["vim-fugitive"] = {
    commands = { "Gstatus", "Gcommit", "Gwrite" },
    loaded = false,
    only_sequence = false,
    only_setup = false,
    path = "/Users/panashe/.local/share/nvim/site/pack/packer/opt/vim-fugitive"
  }
}
...
" Command lazy-loads
command! -nargs=* -range -bang -complete=file UpdateRemotePlugins call s:load(['deoplete.nvim'], { "cmd": "UpdateRemotePlugins", "l1": <line1>, "l2": <line2>, "bang": <q-bang>, "args": <q-args> })
